            ...
            <div className="grid grid-cols-1  md:grid-cols-2 gap-8">
              ...
              <div className="col-span-1">
                ...
                <div className="flex gap-x-3 gap-y-3 md:gap-y-6 md:gap-x-4 flex-wrap">
                  ...
                  <button className="resume-btn">Frontend Development</button>
                  ...
                  <button className="resume-btn">Responsiveness</button>
                  <button className="resume-btn">Pixel Perfect</button>
                </div>
              </div>
            </div>
          </div>
